...
function ItemDetail({id, img, imgpro, nombre, descripcion, loading, cantidad, precio}) {
    ...
    const itemcountChange = () => {
       ...
       const onAdd = () => {
            addToCart({ id: id, img: imgpro, nombre, tipo, cantidad: count, precioU: precio, precio: (precio * count)}) }
